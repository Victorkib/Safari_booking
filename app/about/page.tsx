  ...
  return (
    <main className="py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        <PageHeader
          title="About Safari Adventures"
          description="We are a Kenya-based safari operator dedicated to unforgettable wildlife experiences across East Africa&apos;s most iconic parks and conservancies."
        />
